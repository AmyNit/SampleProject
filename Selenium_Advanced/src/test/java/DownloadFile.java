...
public class DownloadFile {
	...
	public void startBrowser() {
		...
		/*
		 * browser.download.folderList can be set to 0, 1 or 2 0:firefox will
		 * save all the files downloaded via browser on user's desktop
		 * 1:downloads are stored in download location 2:location specified for
		 * the most recent download is utilized again
		 */
		...
		fprofile.setPreference("browser.helperApps.neverAsk.saveToDisk",
				"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;" // MIME
						...
						+ "application/octet-stream;" // MIME type for binary
														// file
						...
						+ "text/csv;" + "application/zip;" + "application/x-gzip;"); // MIME
																						// type
																						// for
																						// Tar
																						// file
		 ...
		 * window when a download begins/default value is true
		 */
		...
		wd = new FirefoxDriver(fprofile); // passing fprofile parameter to use
											// preferences to download file
	...
	public void downloadTest1() throws InterruptedException {
		...
		do {
			...
			System.out.println(file1); // get the size of file to make sure that
										// file is down loaded
			Thread.sleep(8000);
		} while (file1 == 0);
