package com.test.automation.ILAutomation2.testBase;
...
public class TestBase {
	...
	String url = "https://www.countryroad.co.nz/";
	...
	public void takeScreenshot(String name){
		...
		try {
			...
			String reportDirectory=new File(System.getProperty("user.dir")).getAbsolutePath()+"\\src\\main\\java\\com\\test\\automation\\UIAutomation1\\screenshot\\";
